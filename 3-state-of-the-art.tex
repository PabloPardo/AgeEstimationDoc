...
\begin{table}[h!]
	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{l|c|c|c|c|M{2.5cm}|M{2.5cm}|M{2.5cm}|N}
			...
			\multicolumn{1}{|p{1.8cm}|}{\textbf{Images of Gropus \cite{gallagher_cvpr_09_groups}}} & 28.231 & - & 0 - 66+ & Age group & No & No & - &\\[5pt] \hline
			...
			\multicolumn{1}{|p{1.8cm}|}{\textbf{Gallagher’s Web-Collected Database \cite{gallagher_cvpr_09_groups}}} & 28.231 & - & 0 - 66+ & Age Group & No & No & - &\\[5pt] \hline
