...
\note{Talk about close related fields (age synthesis, face validation, etc)}
...
\note{Age Representation: List of techniques}
...
\note{Age Estimation Algorithm: Classificaiton, Regression and Hybrid}
...
\section{Age-based Databases} \label{sec:ageDB}
...
After an initial interest on automatic age estimation from images dated back to the early 2000s \cite{Lanitis:2004:CDC:2225304.2226166}, \cite{993553}, \cite{palDB}, research in the field has experienced a renewed interest from 2006 on, since the availability of large databases like \textit{MORPH-Album 2} \cite{1613043}, which contains 55 times more age-annotated images than the \textit{FG-NET} database.
...
\begin{tabular}{|l|c|c|c|c|M{2.5cm}|M{2.5cm}|M{2.5cm}|N}
	...
	\multicolumn{1}{|p{2cm}|}{\textbf{FG-NET \cite{993553, FGNET}}} & 1,002 & 82 & 0 - 69 & Real Age & No & No & 68 Landmarks &\\[5pt] \hline
...
%	\centering
%	\resizebox{\textwidth}{!}{
%		\begin{tabular}{l|c|c|c|M{1.85cm}|M{2.3cm}|M{2.5cm}|M{2.5cm}|N}
%			\cline{1-8}
%			\cellcolor[HTML]{EFEFEF}\textbf{Database} & \cellcolor[HTML]{EFEFEF}\textbf{\#Faces} & \cellcolor[HTML]{EFEFEF}\textbf{\#Subj.} & \cellcolor[HTML]{EFEFEF}\textbf{Range} & \cellcolor[HTML]{EFEFEF}\textbf{Type of age} & \cellcolor[HTML]{EFEFEF}\textbf{Controlled Env.} & \cellcolor[HTML]{EFEFEF}\textbf{Balanced age Distr.} & \cellcolor[HTML]{EFEFEF}\textbf{Other annotation} &\\[8pt] \hline
%			\multicolumn{1}{|p{2.2cm}|}{\textbf{FG-NET \cite{FGNET}}} & 1.002 & 82 & 0 - 69 & Real Age & No & No & 68 Landmarks &\\[5pt] \hline
%			\multicolumn{1}{|p{2.2cm}|}{\textbf{Morph2 \cite{1613043}}} & 55.134 & - & 16 - 77 & Real Age & Yes & No & - &\\[5pt] \hline
%			\multicolumn{1}{|p{2.2cm}|}{\textbf{YGA \cite{4523958}}} & 8.000 & 1.600 & 0 - 93 & Real Age & No & No & - &\\[5pt] \hline
%			\multicolumn{1}{|p{2.2cm}|}{\textbf{FERET \cite{Phillips1998295}}} & 14.126 & 1.199 & - & Real Age & Partially & No & - &\\[5pt] \hline
%			\multicolumn{1}{|p{2.2cm}|}{\textbf{Iranian face \cite{4469272}}} & ~3.600 & 616 & 2 - 85 & Real Age & No & No & Kind of skin and cosmetic points\footnote{Surgical points, fracture or laceration on face.}  &\\[5pt] \hline
%			\multicolumn{1}{|p{2.2cm}|}{\textbf{PIE \cite{1004130}}} & 41.638 & 68 & - & Real Age & Yes & No & - &\\[5pt] \hline
%			\multicolumn{1}{|p{2.2cm}|}{\textbf{Images of Gropus \cite{gallaghercvpr09groups}}} & 28.231 & - & 0 - 66+ & Age group & No & No & - &\\[5pt] \hline
%			\multicolumn{1}{|p{2.2cm}|}{\textbf{WIT-BD \cite{Ueki:2006:SAC:1126250.1126269}}} & 26.222 & 5.500 & 3 - 85 & Age group & No & No & - &\\[5pt] \hline
%			\multicolumn{1}{|p{2.2cm}|}{\textbf{Caucasian Face Database \cite{burt1995perception}}} & 147 & - & 20 - 62 & Real Age & Yes & No & Shape represented in 208 key points &\\[5pt] \hline
%			\multicolumn{1}{|p{2.2cm}|}{\textbf{LHI \cite{LHI}}} & 8.000 & 8.000 & 9 - 89 & Real Age & Yes & Yes & - &\\[5pt] \hline
%			\multicolumn{1}{|p{2.2cm}|}{\textbf{HOIP \cite{HOIP}}} & 306.600 & 300 & 15 - 64 & Age Group & Yes & No & - &\\[5pt] \hline
%			\multicolumn{1}{|p{2.2cm}|}{\textbf{Gallagher’s Web-Collected Database \cite{gallaghercvpr09groups}}} & 28.231 & - & 0 - 66+ & Age Group & No & No & - &\\[5pt] \hline
%			\multicolumn{1}{|p{2.2cm}|}{\textbf{Ni’s Web-Collected Database \cite{Ni:2009:WIM:1631272.1631287}}} & 219.892 & - & 1 - 80 & Real Age & No & No & - &\\[5pt] \hline
%			
%			\multicolumn{1}{|p{2.2cm}|}{\textbf{OUI-Adience \cite{6906255}}} & 26.580 & 2.284 & 0 - 60+ & Age Group & No & No & Gender &\\[5pt] \hline
%			
%		\end{tabular}
%	}
%	\caption{Age-based Databases}
