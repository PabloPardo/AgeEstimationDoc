...
The first known work on age estimation from facial images was done by Y. Kwon and N. Lobo \cite{Kwon:1999:ACF:311844.311845}. Their approach is based in cranio-facial development theory using geometrical ratios to classify images into one of three age groups (babies, young adults and senior adults).
\subsection{Active Appearance Models}
The first researchers in the field tried to tackle the problem by using geometrical proportions of the different face components  \cite{Lanitis:2004:CDC:2225304.2226166}, 
