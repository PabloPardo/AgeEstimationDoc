...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.7\textwidth]{figures/Label_Distribution}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.7\textwidth]{figures/Labels_across_img}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.7\textwidth]{figures/Labels_across_img_gender}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.7\textwidth]{figures/real_vs_apparent_summer}
