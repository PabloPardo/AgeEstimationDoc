...
where $x_i^j$ and $x_i^{j+1}$ are the filtered values with scales $j$ and $j+1$ at position $i$. $\bar{F}$ is the mean value of the filtered values in the neighbourhood $N_S\times N_S$.

\note{Add image of BIF S1 C1 system}
