...
The \gls{cnn} proposed in this work for age estimation is based on \cite{yiage} \cite{yan2014}. The network was implemented using the Python library Theano to optimize the training using the GPU. The proposed network topology is composed by three convolutional layers each of these followed by subsampling pooling layers and three fully connected layers at the end.
