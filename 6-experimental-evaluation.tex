...
In order to test and validate the method a nested 10-fold cross validation was performed.

As described in Section \ref{sec:BIF} a SVM classifier and three SMR regressors were trained.

Age Group Classification 
Train a linear SVM with parameters c = []
